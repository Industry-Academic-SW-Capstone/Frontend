...
export const analyzeInvestmentStyle = async (
  transactions: Transaction[]
): Promise<InvestmentStyleAnalysis | string> => {
      ...
      config: {
        ...
        responseSchema: {
          ...
          properties: {
            personaName: {
              type: Type.STRING,
              description: "The name of the investor persona in Korean.",
            },
            description: {
              type: Type.STRING,
              description:
                "A brief analysis of the user's investment style in Korean.",
            },
            similarity: {
              type: Type.NUMBER,
              description: "A percentage similarity to the persona.",
            },
            tips: {
              type: Type.ARRAY,
              ...
              items: {
                ...
                properties: {
                  label: {
                    type: Type.STRING,
                    description:
                      "The name of the metric for the radar chart in Korean.",
                  },
                  value: {
                    type: Type.NUMBER,
                    description: "The score for the metric (0-100).",
                  },
                },
