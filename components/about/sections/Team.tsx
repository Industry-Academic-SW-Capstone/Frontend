      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-gray-600 text-xl max-w-2xl mx-auto">
            금융의 미래를 바꾸기 위해 모인 열정적인 팀원들을 소개합니다.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
          {TEAM_MEMBERS.map((member, index) => (
            <div
              key={index}
              className="group bg-white rounded-3xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 text-center"
            >
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2.5rem] p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-10">
              ...
              <br />
              <br />
              우리는 Next.js의 강력한 성능과 직관적인 UI를 결합하여,{" "}
              <br className="hidden md:block" />
              누구나 쉽고 재미있게 금융을 경험할 수 있는 세상을 만들고 있습니다.
            </p>
