    ...
    return (
        <div className={`flex items-center gap-4 p-4 rounded-2xl transition-all duration-300 card-hover overflow-hidden relative group ${
          achievement.unlocked 
            ...
            <div className={`shrink-0 w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 relative z-10 ${
              achievement.unlocked 
  ...
  return (
    <div className="pt-4 space-y-6">
      ...
      <div className="bg-bg-secondary rounded-3xl shadow-lg overflow-hidden animate-fadeInUp">
        <button
          className={`w-full flex items-center justify-between p-6 ${openSection === 'account' ? "pb-3" : "pb-6"} focus:outline-none active:bg-bg-primary/30 transition-colors`}
        ...
        >
          ...
          <Icons.ChevronRightIcon className={`w-6 h-6 text-text-secondary transition-transform duration-300 ${openSection === 'account' ? 'rotate-90' : ''}`}/>
        </button>
        {openSection === 'account' && (
        <div
          className={`grid transition-all duration-300 ease-in-out ${openSection === 'account' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'} bg-bg-secondary`}
          ...
          <div className="divide-y divide-border-color">
            ...
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-text-secondary font-medium">이메일</p>
                  <p className="text-text-primary font-semibold">user@example.com</p>
                </div>
              </div>
            </div>
            {/* Phone */}
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-text-primary font-semibold">010-1234-5678</p>
                </div>
              </div>
            </div>
            {/* Edit Profile Button */}
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-text-primary font-semibold">프로필 수정</span>
              </div>
      ...
      <div className="bg-bg-secondary rounded-3xl shadow-lg overflow-hidden animate-fadeInUp">
        <button
          className={`w-full flex items-center justify-between p-6 ${openSection === 'social' ? "pb-3" : "pb-6"} focus:outline-none active:bg-bg-primary/30 transition-colors`}
        ...
        >
          ...
          <Icons.ChevronRightIcon className={`w-6 h-6 text-text-secondary transition-transform duration-300 ${openSection === 'social' ? 'rotate-90' : ''}`}/>
        </button>
        {openSection === 'social' && (
        <div
          className={`grid transition-all duration-300 ease-in-out ${openSection === 'social' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'} bg-bg-secondary`}
          style={{overflow: 'hidden'}}
        >
          <div className="divide-y divide-border-color">
            {/* Google */}
            ...
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary font-medium">연동 안 됨</p>
                </div>
              </div>
      ...
      <div className="bg-bg-secondary rounded-3xl shadow-lg overflow-hidden animate-fadeInUp">
        <button
          className={`w-full flex items-center justify-between ${openSection === 'achievements' && 'pb-3'} p-6 focus:outline-none active:bg-bg-primary/30 transition-colors`}
        ...
        >
          ...
          <Icons.ChevronRightIcon className={`w-6 h-6 text-text-secondary transition-transform duration-300 ${openSection === 'achievements' ? 'rotate-90' : ''}`}/>
        </button>
        {openSection === 'achievements' && (
        <div
          className={`grid transition-all duration-300 ease-in-out ${openSection === 'achievements' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'} bg-bg-secondary`}
          style={{overflow: 'hidden'}}
        >
      ...
      <div className="bg-bg-secondary rounded-3xl shadow-lg overflow-hidden animate-fadeInUp">
        <button
          className={`w-full flex items-center justify-between p-6 ${openSection === 'settings' && 'pb-3'} focus:outline-none active:bg-bg-primary/30 transition-colors`}
        ...
        >
          ...
          <Icons.ChevronRightIcon className={`w-6 h-6 text-text-secondary transition-transform duration-300 ${openSection === 'settings' ? 'rotate-90' : ''}`}/>
        </button>
        {openSection === 'settings' && (
        <div
          className={`grid transition-all duration-300 ease-in-out ${openSection === 'settings' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'} bg-bg-secondary`}
          style={{overflow: 'hidden'}}
        >
          <div className="divide-y divide-border-color">
            {/* Dark Mode Toggle */}
            <div className="p-4 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-text-primary font-semibold">다크 모드</span>
              </div>
              <button 
            ...
            <button className="w-full p-4 flex items-center justify-between hover:bg-bg-primary/50 transition-colors duration-200 active:bg-bg-primary">
              <div className="flex items-center gap-3">
                ...
                <span className="text-text-primary font-semibold">알림 설정</span>
              </div>
              <Icons.ChevronRightIcon className="w-5 h-5 text-text-secondary"/>
            </button>
            {/* Privacy */}
            <button className="w-full p-4 flex items-center justify-between hover:bg-bg-primary/50 transition-colors duration-200 active:bg-bg-primary">
              <div className="flex items-center gap-3">
                ...
                <span className="text-text-primary font-semibold">개인정보 보호</span>
              </div>
              <Icons.ChevronRightIcon className="w-5 h-5 text-text-secondary"/>
            </button>
            {/* 2차 인증 */}
            ...
            <button className="w-full p-4 flex items-center justify-between hover:bg-bg-primary/50 transition-colors duration-200 active:bg-bg-primary">
              <div className="flex items-center gap-3">
                ...
                <span className="text-text-primary font-semibold">고객 지원</span>
              </div>
              <Icons.ChevronRightIcon className="w-5 h-5 text-text-secondary"/>
            </button>
            {/* Logout */}
