...
const OAuthButtons: React.FC<{ title: string; onOAuth: () => void }> = ({
  title,
  onOAuth,
}) => (
          ...
          <div className="p-6 flex flex-col h-full animate-fadeInUp">
            <div className="h-full flex flex-col justify-between">
              <div>
                ...
                <button
                  onClick={handleNext}
                  className="w-full bg-primary text-white font-bold py-3.5 rounded-xl mt-8"
                >
                  로그인
                </button>
