    ...
    >
      <div className="flex items-start justify-between mb-2">
        <div className="flex-1">
          ...
          <h4 className="font-bold text-text-primary text-sm">{mission.title}</h4>
    ...
    <Portal>
      ...
      <div className="fixed inset-0 z-70 flex items-center justify-center pointer-events-none">
        ...
        >
          ...
          {/* Mission Lists */}
          <div>
            <h3 className="text-base font-bold text-text-primary mb-3">입문</h3>
            <div className="space-y-3">
          ...
          <div>
            <h3 className="text-base font-bold text-text-primary mb-3">중급</h3>
            <div className="space-y-3">
          ...
          <div>
            <h3 className="text-base font-bold text-text-primary mb-3">고급</h3>
            <div className="space-y-3">
